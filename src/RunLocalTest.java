...
public class RunLocalTest {
    ...
    public void testLoginGUIDeclarations() {
        ...
        try {
            ...
            if (field.getType() != JTextField.class) {
                fail("The field `passText` in LoginGUI is not a type of JTextField");
                return;
            }
            if (field.getModifiers() != Modifier.PRIVATE) {
        ...
        try {
            ...
            if (field.getModifiers() != Modifier.PROTECTED) {
                fail("The field `actionListener` in LoginGUI is not protected");
                return;
            }
        } catch (NoSuchFieldException e) {
    ...
    public void testChatGUIDeclarations() {
        ...
        try {
            ...
            if (field.getModifiers() != Modifier.PROTECTED) {
                fail("The field `actionListener` in ChatGUI is not protected");
                return;
            }
        } catch (NoSuchFieldException e) {
        ...
        try {
            ...
            if (field.getModifiers() != Modifier.PROTECTED) {
                fail("The field `focusListener` in ChatGUI is not protected");
                return;
            }
        } catch (NoSuchFieldException e) {
        ...
        try {
            ...
            if (field.getModifiers() != Modifier.PROTECTED) {
                fail("The field `mouseListener` in ChatGUI is not protected");
                return;
            }
        } catch (NoSuchFieldException e) {
    ...
    public void testDisplayMessageGUIDeclarations() {
        ...
        try {
            ...
            if (field.getModifiers() != Modifier.PROTECTED) {
                fail("The field `mouseListener` in DisplayMessageGUI is not protected");
                return;
            }
        } catch (NoSuchFieldException e) {
